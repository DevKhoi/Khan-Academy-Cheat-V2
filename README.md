# Khan Acedemy Cheat V2

  *Working as of 10/01/2024 (Thanks to [@adubov1](https://github.com/adubov1))* 
...
2. Use [this link](https://github.com/DevKhoi/Khan-Academy-Cheat-V2/raw/main/Khan-Academy-Cheat_V2.js) to install the script. 
